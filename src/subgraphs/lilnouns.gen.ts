...
export type DelegateFilter = {
  ...
  nounsRepresented_contains_nocase?: InputMaybe<
  ...
  nounsRepresented_not_contains_nocase?: InputMaybe<
    Array<Scalars["String"]["input"]>
  >;
...
export type DynamicQuorumParamsFilter = {
  ...
  dynamicQuorumStartBlock_not_in?: InputMaybe<
...
export type ProposalCandidateContentFilter = {
  ...
  matchingProposalIds_contains_nocase?: InputMaybe<
    Array<Scalars["BigInt"]["input"]>
  >;
  matchingProposalIds_not?: InputMaybe<Array<Scalars["BigInt"]["input"]>>;
  matchingProposalIds_not_contains?: InputMaybe<
    Array<Scalars["BigInt"]["input"]>
  >;
  matchingProposalIds_not_contains_nocase?: InputMaybe<
    Array<Scalars["BigInt"]["input"]>
  >;
...
export type TransferEventFilter = {
  ...
  previousHolder_not_starts_with_nocase?: InputMaybe<
    Scalars["String"]["input"]
  >;
